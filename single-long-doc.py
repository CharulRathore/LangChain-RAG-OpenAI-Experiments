...
loader = PyPDFLoader('./docs/ProductManual.pdf')
...
# we can now exectute queries against our Q&A chain
result = qa_chain.invoke({'query': 'What camera specifications does the XYZ Smartphone have?'})
print(result['result'])
